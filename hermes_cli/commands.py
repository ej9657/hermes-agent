...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               ...
               busy_policy="dispatch"),
    CommandDef("tctx", "Show indexed Telegram context and project routing",
               "Tools & Skills", aliases=("telegram-context", "tgctx"),
               args_hint="[recent|tasks|brief|route|refresh] [chat|category]",
...
_SLACK_VIA_HERMES_ONLY = frozenset({
    "topup", "moa", "debug", "egress", "init", "version", "diff", "update", "tctx"
})
